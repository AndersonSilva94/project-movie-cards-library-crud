# Projeto Movie Cards Library CRUD :film_projector:

### Décimo segundo projeto do curso de Desenvolvimento Full Stack Web da Trybe.

## Objetivos a serem alcançados no decorrer da construção do projeto:

Dando continuidade aos últimos projetos, será criado um **CRUD** de cartões de filmes em React. 
...
- Utilizando o componente BrowserRouter corretamente;

- Criando links de navegação na aplicação com o componente Link ;

- Criando rotas, mapeando o caminho da URL com o componente correspondente, via Route ;
- Estruturando e organizando as rotas da sua aplicação com o componente Switch ;

- Usando o componente Redirect pra alternar entre rotas.
...
1. Clone o repositório
  * `git clone git@github.com:AndersonSilva94/project-movie-cards-library-crud.git`.
